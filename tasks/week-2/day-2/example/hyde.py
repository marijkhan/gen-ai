...
def ask():
   ...
   hypo_answer = askLLM('You are a helpful chatbot', input_query)
   print("hypo answer:")
   print(hypo_answer)
   
   retrieved_knowledge = retrieve(hypo_answer)
   ...
   '''
   actual_answer = askLLM(instruction_prompt, input_query)
   print("actual answer:")
   print(actual_answer)

def askLLM(instruction_prompt, input_query):
